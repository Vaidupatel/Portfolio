...
export const LINKEDIN_URL = "https://linkedin.com/in/vaidpatel11/";

export const OFFICE_LOCATION = "Ahmedabad, Gujarat, India";
export const OFFICE_TIMEZONE = "Asia/Kolkata";
export const OFFICE_AVAILABILITY = "Available for select remote/freelance projects";
