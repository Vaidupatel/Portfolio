...
PinContainer.propTypes = {
  children: PropTypes.node.isRequired, // Renderable React children
  title: PropTypes.string.isRequired, // Title string for the Pin
  href: PropTypes.string, // URL link (optional)
  className: PropTypes.string, // CSS class for customization
  containerClassName: PropTypes.string, // CSS class for container
};
PinPerspective.propTypes = {
  title: PropTypes.string.isRequired, // Title to be displayed
  href: PropTypes.string.isRequired, // URL to link the button
};
